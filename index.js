function inputListener(evx) {
    isMirror = ["r", "g", "b"].indexOf(
      evx.target.getAttribute("class").substr(0, 1)
    );
    if (isMirror > -1 && !!window.isMirrorMode) {
      ...
      document.querySelector(classToModify + "p").style.opacity =
        (100 - evx.target.value) / 100;
    }
  ...
  function setColour(col) {
    ...
    for (let i = 0; i < col.length; i++) {
      ...
      document.querySelector(
        ...
        document.querySelector("." + ["r", "g", "b", "c", "m", "y"][i] + "i")
          .value / 100;
    }
    updatePreviews();
  }
  ...
  function updatePreviews() {
    ...
    document.querySelector(".rgbc").style.backgroundColor =
      "rgb(" + r + "," + g + "," + b + ")";
    ...
    document.querySelector(".cmyc").style.backgroundColor =
      "rgb(" + c * 255 + "," + m * 255 + "," + y * 255 + ")";
  }
